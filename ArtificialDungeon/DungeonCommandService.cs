  ...
  public class DungeonCommandService : ICommandService
  {
    ...
    private async Task EnterTheDungeon(ExecuteCommandArgs args)
    {
      ...
      lock (this.locker)
      {
        ...
        message = YandexTranslator.Instance.Translate(storyDescription, Language.ru).Result;
      }
    ...
    private Task DungeonAction(ExecuteCommandArgs args)
    {
      ...
      lock (this.locker)
      {
        ...
        message = YandexTranslator.Instance.Translate(response, Language.ru).Result;
      }
